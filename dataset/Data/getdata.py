...
def generate_train_test_split():
    for spk in __SPEAKERS__:
        ...
        for item in train_data:
            file_str += item + "|" + str(int(__SPEAKERS__.index(spk))) + "/n"
...
if __name__ == "__main__":
    # VCTK Corpus Path
    __CORPUSPATH__ = "D:/lth/GitHub/emo-stargan/sughosh/Dataset/wav48_silence_trimmed/"
    __OUTPATH__ = "D:/lth/GitHub/emo-stargan/sughosh/Dataset/VCTK-24k-All/"
