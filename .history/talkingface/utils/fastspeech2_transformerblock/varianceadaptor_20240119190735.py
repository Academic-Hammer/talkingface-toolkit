...
from talkingface.utils.fastspeech2_transformerblock.tools import get_mask_from_lengths, pad
...
class VarianceAdaptor(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.pitch_embedding = nn.Embedding(
            n_bins, config["transformer"]["encoder_hidden"]
        )
...
class VariancePredictor(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.input_size = config["transformer"]["encoder_hidden"]
        self.filter_size = config["variance_predictor"]["filter_size"]
        self.kernel = config["variance_predictor"]["kernel_size"]
