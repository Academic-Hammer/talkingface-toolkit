...
class FastSpeech2Dataset(Dataset):
    def __init__(
        self, filename, config, train_config, sort=False, drop_last=False
    ):
...
if __name__ == "__main__":
    ...
    train_dataset = Dataset(
        "train.txt", config, train_config, sort=True, drop_last=True
    )
    val_dataset = Dataset(
        "val.txt", config, train_config, sort=False, drop_last=False
    )
