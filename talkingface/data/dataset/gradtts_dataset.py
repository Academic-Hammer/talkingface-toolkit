...
from talkingface.data.dataset.gradtts.text import text_to_sequence, cmudict
from talkingface.data.dataset.gradtts.text import symbols
from talkingface.data.dataset.gradtts.utils import parse_filelist, intersperse
from talkingface.model.text_to_speech.tts.utils import fix_len_compatibility
from talkingface.data.dataset.gradtts.params import seed as random_seed

import sys
sys.path.insert(0, 'gradtts/hifigan')
from talkingface.data.dataset.gradtts.hifigan.meldataset import mel_spectrogram
from talkingface.data.dataset.dataset import Dataset


class GradTTSDataset(Dataset):
    def __init__(self, config, datasplit):
        super().__init__(config, datasplit)
        filelist_path = datasplit
