...
parser.add_argument('--dataset_video_root', type=str, default='dataset/lrs2')
parser.add_argument('--output_sketch_root', type=str, default='dataset/lrs2/lrs2_preprocessed/lrs2_sketch')
parser.add_argument('--output_face_root', type=str, default='dataset/lrs2/lrs2_preprocessed/lrs2_face')
parser.add_argument('--output_landmark_root', type=str, default='dataset/lrs2/lrs2_preprocessed/lrs2_landmarks')
