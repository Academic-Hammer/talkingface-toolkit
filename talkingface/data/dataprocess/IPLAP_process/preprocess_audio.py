import sys
# 从preprocess_audio.py的角度添加到talkingface的根目录
sys.path.append("../../../")

from talkingface.model.audio_driven_talkingface.IPLAP.models import audio
from os import path
...
# 设置 --data_root 的默认值为 'dataset/lrs2'
parser.add_argument("--data_root", type=str, help="Root folder of the LRS2 dataset", default="dataset/lrs2")
# 设置 --out_root 的默认值为 'dataset/lrs2/lrs2_preprocessed'
parser.add_argument("--out_root", help="output audio root", default="dataset/lrs2/lrs2_preprocessed/lrs2_audio")
