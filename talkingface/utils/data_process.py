...
class cnnPreprocess():
    ...
    def steps(self, step):
        ...
        """
        running_step = step
        vid_file = 'dataset\cnn\data\cnn.mp4'
        ...
        if running_step == 0:
            ...
            extract_ds_cmd = 'python talkingface\data\dataprocess\DFRD_process_helper\deepspeech_features\extract_ds_features.py --input=' + id_dir
        ...
        if running_step == 3:
            ...
            face_parsing_cmd = 'python talkingface/data/dataprocess/DFRD_process_helper/face_parsing/test.py --respath=' + \
        ...
        if running_step == 6:
            ...
            est_pose_cmd = 'python talkingface/data/dataprocess/DFRD_process_helper/face_tracking/face_tracker.py --idname=' + \
