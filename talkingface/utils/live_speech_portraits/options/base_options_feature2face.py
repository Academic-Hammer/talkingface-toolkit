...
class BaseOptions():
    ...
    def initialize(self):  
        ...
        self.parser.add_argument('--model_name', type=str, default='feature2face', help='chooses which model to use. vid2vid, test')
        ...
        self.parser.add_argument('--dataset', type=str, default='default', help='useless, just for dataset=live_speech_portraits')
        self.parser.add_argument('--model', type=str, default='default', help='useless, just for model=live_speech_portraits')
