...
import os
import torch
from talkingface.utils.live_speech_portraits.util import util
import talkingface.model.audio_driven_talkingface.LiveSpeechPortraits as models
import numpy as np
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        ## useless parameters 新加的参数
        parser.add_argument('--dataset', type=str, default='default', help='useless, just for dataset=live_speech_portraits')
        parser.add_argument('--model', type=str, default='default', help='useless, just for model=live_speech_portraits')

        ## basic parameters
        parser.add_argument('--model_name', type=str, default='audio2headpose', help='trained model')
