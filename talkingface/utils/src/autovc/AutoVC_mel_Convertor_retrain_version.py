...
from talkingface.utils.src.autovc.retrain_version.model_vc_37_1 import Generator
...
class AutoVC_mel_Convertor():
    ...
    def convert_wav_to_autovc_input(self, build_train_dataset=True, autovc_model_path=r'E:\Dataset\VCTK\stargan_vc\train_85_withpre1125000_local\360000-G.ckpt'):
        ...
        emb = np.loadtxt('talkingface/utils/src/autovc/retrain_version/obama_emb.txt')
    ...
    def convert_single_wav_to_autovc_input(self, audio_filename, autovc_model_path):
        ...
        from talkingface.utils.src.autovc.retrain_version.vocoder_spec.extract_f0_func import extract_f0_func_audiofile
        x_real_src, f0_norm = extract_f0_func_audiofile(audio_file, 'F')
        from talkingface.utils.src.autovc.utils import quantize_f0_interp
