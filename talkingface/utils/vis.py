...
class Vis():
    ...
    def __init__(self, fls, filename, audio_filenam=None, fps=100, frames=1000):
        ...
        writer = cv2.VideoWriter(os.path.join('dataset/examples', 'tmp.mp4'),
        ...
        if(audio_filenam is not None):
            ...
            os.system('ffmpeg -y -i {} -i {} -strict -2 -shortest {}'.format(
                os.path.join('dataset/examples', 'tmp.mp4'),
                audio_filenam,
                os.path.join('dataset/examples', '{}_av.mp4'.format(filename))
            ))
        else:
        ...
        os.remove(os.path.join('dataset/examples', 'tmp.mp4'))
