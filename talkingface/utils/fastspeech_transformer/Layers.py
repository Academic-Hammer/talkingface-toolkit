...
from talkingface.utils.fastspeech_transformer.SubLayers import MultiHeadAttention, PositionwiseFeedForward
from talkingface.utils.text.symbols import symbols
...
class FFTBlock(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.pos_ffn = PositionwiseFeedForward(
            config,d_model, d_inner, dropout=dropout)
