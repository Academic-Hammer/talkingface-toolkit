...
import yaml
from talkingface.model.abstract_speech import AbstractSpeech
...
class StyleTTS2(AbstractSpeech):
    def __init__(self):
    ...
    def loadmodel(self,config):
        ...
        return build_model(model_params, text_aligner, pitch_extractor, plbert)
