...
from talkingface.utils.utils import cc
from model.abstract_talkingface import AbstractTalkingFace

class MLP(AbstractTalkingFace):
...
class Prenet(AbstractTalkingFace):
...
class Postnet(AbstractTalkingFace):
...
class SpeakerEncoder(AbstractTalkingFace):
...
class ContentEncoder(AbstractTalkingFace):
    def __init__(self, c_in, c_h, c_out, kernel_size,
            bank_size, bank_scale, c_bank, 
...
class Decoder(AbstractTalkingFace):
    def __init__(self, 
