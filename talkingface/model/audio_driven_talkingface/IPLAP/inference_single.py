...
parser.add_argument('--input', '--input_template_video', type=str,
                    default='talkingface/model/audio_driven_talkingface/IPLAP/test/template_video/129.mp4')
# 'talkingface/model/audio_driven_talkingface/IPLAP/test/template_video/129.mp4'
# 'talkingface/model/audio_driven_talkingface/IPLAP/test/template_video/test1.mp4'
# 'talkingface/model/audio_driven_talkingface/IPLAP/test/template_video/test2.mp4'


parser.add_argument('--audio', type=str,
                    default='talkingface/model/audio_driven_talkingface/IPLAP/test/template_video/audio2.wav')
# 'talkingface/model/audio_driven_talkingface/IPLAP/test/template_video/abstract.mp3'
# 'talkingface/model/audio_driven_talkingface/IPLAP/test/template_video/speech_test.mp3'
# 'talkingface/model/audio_driven_talkingface/IPLAP/test/template_video/speech_test2.mp3'
# 'talkingface/model/audio_driven_talkingface/IPLAP/test/template_video/audio2.wav'
...
parser.add_argument('--landmark_gen_checkpoint_path', type=str,
                    default='talkingface/model/audio_driven_talkingface/IPLAP/test/checkpoints/landmarkgenerator_checkpoint.pth')
parser.add_argument('--renderer_checkpoint_path', type=str,
                    default='talkingface/model/audio_driven_talkingface/IPLAP/test/checkpoints/renderer_checkpoint.pth')
...
for frame_idx in range(ref_img_full_face_landmarks.shape[0]):  # N
    ...
    mediapipe_format_landmarks = [
        LandmarkDict(ori_sequence_idx[full_face_landmark_sequence[idx]], full_landmarks[0, idx],
...
# print("\nsuccess!\n")
# print("succeed to:", input_audio_path)
# print("succeed to:", '{}/result.avi'.format(temp_dir))
# print("succeed to:", outfile_path)
...
# output_file = './test_result/output_video.mp4'
output.run_ffmpeg_command(input_audio_path, '{}/result.avi'.format(temp_dir), outfile_path)
